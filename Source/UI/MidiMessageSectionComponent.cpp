...
MidiMessageSectionComponent::MidiMessageSectionComponent() :
    ...
    cmdKeyTypeRadioGroup.setText("Key cmd type");
    ...
    cmdKeyTypeLatch.onClick = [this] { sendChangeMessage(); };
    ...
    cmdKeyTypeMomentary.onClick = [this] { sendChangeMessage(); };
    ...
    cmdKeyTypeTrigger.onClick = [this] { sendChangeMessage(); };

    midiMsgTypeRadioGroup.setText("Message type");
    ...
    midiMsgTypeCC.onClick = [this] { sendChangeMessage(); };
    ...
    midiMsgTypeProgChange.onClick = [this] { sendChangeMessage(); };
    ...
    midiMsgTypeRealtime.onClick = [this] { sendChangeMessage(); };
    ...
    midiMsgTypeAllNotesOff.onClick = [this] { sendChangeMessage(); };

    realtimeMsgGroup.setText("Sys Realtime");
    ...
    realtimeOn.box.onChange = [this] { sendChangeMessage(); };
    realtimeOff.box.onChange = [this] { sendChangeMessage(); };
...
juce::String MidiMessageSectionComponent::getMessageString() {
    ...
    if (cmdKeyTypeLatch.getToggleState()) cmdType = "Latch";
    else if (cmdKeyTypeMomentary.getToggleState()) cmdType = "Momentary";
    else if (cmdKeyTypeTrigger.getToggleState()) cmdType = "Trigger";
    
    if (midiMsgTypeCC.getToggleState()) msgType = "CC";
    else if (midiMsgTypeProgChange.getToggleState()) msgType = "PC";
    else if (midiMsgTypeRealtime.getToggleState()) msgType = "Realtime";
    else if (midiMsgTypeAllNotesOff.getToggleState()) msgType = "AllNotesOff";
    ...
    return cmdType + ";" + msgType + ";" + juce::String(midiCmdValue.getValue()) + ";" + offVal + ";" + onVal;
}

void MidiMessageSectionComponent::updatePanelFromMessageString(const juce::String& msgString) {
